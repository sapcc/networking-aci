...
def parse_args():
    ...
    parser.add_argument(
        ...
        action='append',
        default=['/etc/neutron/neutron.conf','/etc/neutron/plugins/ml2/ml2_conf.ini','/etc/neutron/plugins/ml2/ml2-conf-aci.ini'],
        required=False
    )
    ...
    parser.add_argument(
        '--mode', help="Mode to use check or sync. 'check' evaluates inconsistences, sync with sync neutron state to ACI",
